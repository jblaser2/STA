...
Reads pca542_motor_easy_hc.mat (from PEET pca command), applies sklearn k-means on
...
RESULTS = "/home/jblaser2/Research/peet/motor_easy_hc/results"
MAT     = os.path.join(RESULTS, "pca542_motor_easy_hc.mat")
LABELS  = "/home/jblaser2/Research/synthetic_sta/motor_easy/hc_test_x6/subtomos/merged_AC_full/labels.csv"
STA_DIR = "/home/jblaser2/Research/STA"
OUT_DIR = "outputs/FM_easy/peet"
