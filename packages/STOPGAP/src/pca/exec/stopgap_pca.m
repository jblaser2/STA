...
% Local-copy is not wired into the PCA path (the dispatcher does not pass
% copy_local, and the PCA settings struct lacks the n_cores/n_nodes fields
% that check_copy_local needs). Replicate the "not copying locally" branch of
% subtomo_check_copy_local directly so shared funcs (e.g. get_subtomo_boxsize,
% read_vol) find o.copy_local and o.rootdir. Matches sg_run's copy_local=0.
o.copy_local = false;
