...
| **FM_easy** (2-class hc, 542p) | ✅ | k=2 / k=2 | **cylinder** (r27 h24) | **0.262** | 325/217 | auto_focus_classify `-a`; **cylinder mask adopted 2026-06-17** — CC/template method gains a lot from a tight focus mask (diff sphere gave only 0.031; cylinder converged at iter6). Confusion: `outputs/FM_easy/pytom/` |
