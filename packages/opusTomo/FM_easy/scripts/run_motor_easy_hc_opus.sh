...
PROJ_DIR="$SCRIPT_DIR/opus_project_motor_easy_hc"
LOG="$PROJ_DIR/run.log"

PARTICLE_DIR="$HOME/Research/synthetic_sta/motor_easy/hc_test_x6/subtomos/merged_AC_full"
...
if [[ ! -f "$PROJ_DIR/particles.star" ]]; then
    run_step "Step 1: Write STAR file" python "$SCRIPT_DIR/setup_motor_easy_hc_opus.py" "$PROJ_DIR"
else
...
RESULT_CSV="$REPO_ROOT/outputs/FM_easy/opus/opus_motor_easy_k2.csv"
