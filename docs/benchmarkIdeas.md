...
- `results/protomo_T4P_k3.csv` — ProTomo T4P all 672 particles (class 2 = junk)
- `results/T4P/<pkg>_k<k>_std.csv` — standardised per-package CSVs (columns: `particle`, `class_int`, `class_name`); generated by `scripts/eval/standardize_t4p_results.py`
- `results/T4P/fsc_summary.csv` — half-set FSC resolution at FSC=0.143 and FSC=0.5 per group
